...
export default function HomePage() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
      <section className="fade-in flex flex-col gap-6 sm:flex-row sm:items-center">
        <div className="relative h-28 w-28 flex-none overflow-hidden rounded-full border border-[var(--border)] bg-[var(--bg-elev)]">
          <Image
